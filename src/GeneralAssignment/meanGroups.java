...
//        Map<Double, List<int[]>> map = new TreeMap<>(new Comparator<Double>() {
//            @Override
//            public int compare(Double o1, Double o2) {
////                return map.get(o1).get(0);
//            }
//        });
//        for (int i = 0; i < means.length; i++) {
//            means[i] = findMean(a[i]);
//        }
//
//
//        for (int i = 0; i < means.length; i++) {
//            List<int[]> list = map.get(means[i]);
//            if (list == null) {
//                list = new ArrayList<>();
//            }
//            Arrays.sort(a[i]);
...
//    }
//
//    private double findMean(int[] ints) {
//        int sum = 0;
//        for (int num : ints) {
//            sum += num;
//        }
